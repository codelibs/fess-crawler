...
public abstract class BsAccessResultBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends AccessResult> void doSelectCursor(
            final AccessResultCB cb, final EntityRowHandler<ENTITY> entityRowHandler,
    ...
    protected <ENTITY extends AccessResult> ENTITY doSelectByPKValue(final Long id,
            final Class<ENTITY> entityType) {
    ...
    public List<AccessResultData> pulloutAccessResultDataAsOne(
        ...
        return helpPulloutInternally(
            ...
            new InternalPulloutCallback<AccessResult, AccessResultData>() {
                ...
                public void setRfLs(final AccessResultData e, final List<AccessResult> ls) {
                    if (!ls.isEmpty()) {
     ...
     */
    public int queryUpdate(final AccessResult accessResult, final AccessResultCB cb) {
        return doQueryUpdate(accessResult, cb, null);
    }

    protected int doQueryUpdate(final AccessResult accessResult, final AccessResultCB cb,
            final UpdateOption<AccessResultCB> option) {
        assertObjectNotNull("accessResult", accessResult);
        assertCBNotNull(cb);
        prepareUpdateOption(option);
     ...
     */
    public int varyingQueryUpdate(final AccessResult accessResult, final AccessResultCB cb,
            final UpdateOption<AccessResultCB> option) {
        assertUpdateOptionNotNull(option);
    ...
    protected <ENTITY extends AccessResult> void delegateSelectCursor(
            final AccessResultCB cb, final EntityRowHandler<ENTITY> erh, final Class<ENTITY> et) {
    ...
    // Update
    // ------
    protected int delegateInsert(final AccessResult e, final InsertOption<AccessResultCB> op) {
    ...
    protected int delegateUpdate(final AccessResult e, final UpdateOption<AccessResultCB> op) {
    ...
    protected int delegateDelete(final AccessResult e, final DeleteOption<AccessResultCB> op) {
    ...
    protected int delegateQueryInsert(final AccessResult e, final AccessResultCB inCB,
            final ConditionBean resCB, final InsertOption<AccessResultCB> op) {
    ...
    protected int delegateQueryUpdate(final AccessResult e, final AccessResultCB cb,
            final UpdateOption<AccessResultCB> op) {
