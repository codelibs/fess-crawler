...
public class BsAccessResultCQ extends AbstractBsAccessResultCQ {
    ...
    // Constructor
    // ===========
    public BsAccessResultCQ(final ConditionQuery childQuery, final SqlClause sqlClause,
     ...
     * @return this. (NotNull)
     */
    public BsAccessResultCQ addSpecifiedDerivedOrderBy_Asc(final String aliasName) {
     ...
     * @return this. (NotNull)
     */
    public BsAccessResultCQ addSpecifiedDerivedOrderBy_Desc(final String aliasName) {
