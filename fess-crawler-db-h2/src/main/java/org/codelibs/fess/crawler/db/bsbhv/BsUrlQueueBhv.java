...
public abstract class BsUrlQueueBhv extends AbstractBehaviorWritable<UrlQueue, UrlQueueCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">urlQueue</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">urlQueue</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * UrlQueue <span style="color: #553000">urlQueue</span> = <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">urlQueue</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlQueue. (NotNull)
     ...
     * <pre>
     * ListResultBean&lt;UrlQueue&gt; <span style="color: #553000">urlQueueList</span> = <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (UrlQueue <span style="color: #553000">urlQueue</span> : <span style="color: #553000">urlQueueList</span>) {
     *     ... = <span style="color: #553000">urlQueue</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlQueue. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;UrlQueue&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (UrlQueue urlQueue : <span style="color: #553000">page</span>) {
     *     ... = urlQueue.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlQueue. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * <pre>
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * UrlQueue urlQueue = <span style="color: #70226C">new</span> UrlQueue();
     ...
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">insert</span>(urlQueue);
     ...
     * urlQueue.<span style="color: #CC4747">setVersionNo</span>(value);
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">update</span>(urlQueue);
     * </pre>
     ...
     *     <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">delete</span>(urlQueue);
     ...
     * }
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">batchInsert</span>(urlQueueList);
     * </pre>
     ...
     *     urlQueueList.add(urlQueue);
     * }
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">batchUpdate</span>(urlQueueList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;UrlQueue, UrlQueueCB&gt;() {
     ...
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">queryUpdate</span>(urlQueue, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">queryDelete</span>(urlQueue, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlQueue. (NotNull)
     ...
     * urlQueue.setFoo...(value);
     * urlQueue.setBar...(value);
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">varyingInsert</span>(urlQueue, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(urlQueue, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//urlQueue.setVersionNo(value);</span>
     * <span style="color: #0000C0">urlQueueBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(urlQueue, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * urlQueueBhv.outideSql().selectCursor(pmb, handler); <span style="color: #3F7E5E">// (by handler)</span>
     ...
     */
    public OutsideSqlAllFacadeExecutor<UrlQueueBhv> outsideSql() {
        return doOutsideSql();
    }
