 ...
 * java.math.BigDecimal contentLength = entity.getContentLength();
...
public abstract class BsAccessResultDiff implements Entity, Serializable,
    ...
    protected java.math.BigDecimal _contentLength;
    ...
    /**
     * [set] HTTP_STATUS_CODE: {NUMBER(4)} <br />
     * 
    ...
    /**
     * [set] CONTENT_LENGTH: {NUMBER(19)} <br />
     * 
     * @param contentLength
     *            The value of the column 'CONTENT_LENGTH'. (NullAllowed: null
     *            update allowed for no constraint)
     */
    public void setContentLength(final java.math.BigDecimal contentLength) {
    ...
    /**
     * [set] EXECUTION_TIME: {NUMBER(9)} <br />
     * 
     * @param executionTime
    ...
    /**
     * [set] CREATE_TIME: {TIMESTAMP(11, 6)} <br />
     * 
     * @param createTime
