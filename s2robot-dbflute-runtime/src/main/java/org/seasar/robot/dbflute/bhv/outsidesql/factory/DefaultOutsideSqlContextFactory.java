...
public class DefaultOutsideSqlContextFactory implements OutsideSqlContextFactory {
     ...
     * {@inheritDoc}
     */
    public OutsideSqlContext createContext(DBMetaProvider dbmetaProvider, String outsideSqlPackage) {
        return new OutsideSqlContext(dbmetaProvider, outsideSqlPackage);
    }
}
