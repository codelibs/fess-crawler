...
public abstract class AbstractBsAccessResultCQ extends AbstractConditionQuery {
     ...
     */
    public void setHttpStatusCode_InScope(final Collection<Integer> httpStatusCodeList) {
     ...
     */
    public void setContentLength_InScope(final Collection<Long> contentLengthList) {
        doSetContentLength_InScope(contentLengthList);
    }

    protected void doSetContentLength_InScope(final Collection<Long> contentLengthList) {
        regINS(
            CK_INS,
     ...
     */
    public void setContentLength_NotInScope(final Collection<Long> contentLengthList) {
     ...
     */
    public void setExecutionTime_InScope(final Collection<Integer> executionTimeList) {
