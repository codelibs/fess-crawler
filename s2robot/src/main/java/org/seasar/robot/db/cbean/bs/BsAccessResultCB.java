...
public class BsAccessResultCB extends AbstractConditionBean {
    ...
    public AccessResultCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new AccessResultCQ(null, getSqlClause(), getSqlClause().getLocalTableAliasName(), 0);
        }
    ...
    public void union(UnionQuery<AccessResultCB> unionQuery) {
        final AccessResultCB cb = new AccessResultCB(); cb.xsetupForUnion(); unionQuery.query(cb);
    ...
    public Specification specify() {
        if (_specification == null) { _specification = new Specification(this, new SpQyCall<AccessResultCQ>() {
            public boolean has() { return true; } public AccessResultCQ qy() { return query(); } }, _forDerivedReferrer, _forScalarSelect, _forScalarSubQuery, getDBMetaProvider()); }
        return _specification;
    }

    public static class Specification extends AbstractSpecification<AccessResultCQ> {
        protected SpQyCall<AccessResultCQ> _myQyCall;
        protected AccessResultDataCB.Specification _accessResultDataAsOne;
        public Specification(ConditionBean baseCB, SpQyCall<AccessResultCQ> qyCall
                           , boolean forDeriveReferrer, boolean forScalarSelect, boolean forScalarSubQuery
                           , DBMetaProvider dbmetaProvider)
        { super(baseCB, qyCall, forDeriveReferrer, forScalarSelect, forScalarSubQuery, dbmetaProvider); _myQyCall = qyCall; }
        public void columnId() { doColumn("ID"); }
        public void columnSessionId() { doColumn("SESSION_ID"); }
        public void columnRuleId() { doColumn("RULE_ID"); }
        ...
        public void columnHttpStatusCode() { doColumn("HTTP_STATUS_CODE"); }
        public void columnMethod() { doColumn("METHOD"); }
        public void columnMimeType() { doColumn("MIME_TYPE"); }
        ...
        public AccessResultDataCB.Specification specifyAccessResultDataAsOne() {
            ...
            if (_accessResultDataAsOne == null) {
                _accessResultDataAsOne = new AccessResultDataCB.Specification(_baseCB, new SpQyCall<AccessResultDataCQ>() {
                    public boolean has() { return _myQyCall.has() && _myQyCall.qy().hasConditionQueryAccessResultDataAsOne(); }
                    public AccessResultDataCQ qy() { return _myQyCall.qy().queryAccessResultDataAsOne(); } }
