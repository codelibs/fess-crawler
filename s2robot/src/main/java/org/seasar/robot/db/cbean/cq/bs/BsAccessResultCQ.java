...
public class BsAccessResultCQ extends AbstractBsAccessResultCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsAccessResultCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public AccessResultCIQ inline() {
        if (_inlineQuery == null) {
            _inlineQuery = new AccessResultCIQ(getChildQuery(), getSqlClause(), getAliasName(), getNestLevel(), this);
        }
    ...
    public AccessResultCIQ on() {
        ...
        AccessResultCIQ inlineQuery = inline(); inlineQuery.xsetOnClauseInline(true); return inlineQuery;
    }
    ...
    public Map<String, AccessResultDataCQ> getId_InScopeSubQuery_AccessResultDataAsOne() { return _id_InScopeSubQuery_AccessResultDataAsOneMap; }
    public String keepId_InScopeSubQuery_AccessResultDataAsOne(AccessResultDataCQ subQuery) {
        if (_id_InScopeSubQuery_AccessResultDataAsOneMap == null) { _id_InScopeSubQuery_AccessResultDataAsOneMap = newLinkedHashMap(); }
        String key = "subQueryMapKey" + (_id_InScopeSubQuery_AccessResultDataAsOneMap.size() + 1);
        _id_InScopeSubQuery_AccessResultDataAsOneMap.put(key, subQuery); return "id_InScopeSubQuery_AccessResultDataAsOne." + key;
    }

    protected Map<String, AccessResultDataCQ> _id_NotInScopeSubQuery_AccessResultDataAsOneMap;
    public Map<String, AccessResultDataCQ> getId_NotInScopeSubQuery_AccessResultDataAsOne() { return _id_NotInScopeSubQuery_AccessResultDataAsOneMap; }
    public String keepId_NotInScopeSubQuery_AccessResultDataAsOne(AccessResultDataCQ subQuery) {
        if (_id_NotInScopeSubQuery_AccessResultDataAsOneMap == null) { _id_NotInScopeSubQuery_AccessResultDataAsOneMap = newLinkedHashMap(); }
        String key = "subQueryMapKey" + (_id_NotInScopeSubQuery_AccessResultDataAsOneMap.size() + 1);
        _id_NotInScopeSubQuery_AccessResultDataAsOneMap.put(key, subQuery); return "id_NotInScopeSubQuery_AccessResultDataAsOne." + key;
    }

    protected Map<String, AccessResultDataCQ> _id_ExistsSubQuery_AccessResultDataAsOneMap;
    public Map<String, AccessResultDataCQ> getId_ExistsSubQuery_AccessResultDataAsOne() { return _id_ExistsSubQuery_AccessResultDataAsOneMap; }
    public String keepId_ExistsSubQuery_AccessResultDataAsOne(AccessResultDataCQ subQuery) {
        if (_id_ExistsSubQuery_AccessResultDataAsOneMap == null) { _id_ExistsSubQuery_AccessResultDataAsOneMap = newLinkedHashMap(); }
        String key = "subQueryMapKey" + (_id_ExistsSubQuery_AccessResultDataAsOneMap.size() + 1);
        _id_ExistsSubQuery_AccessResultDataAsOneMap.put(key, subQuery); return "id_ExistsSubQuery_AccessResultDataAsOne." + key;
    }

    protected Map<String, AccessResultDataCQ> _id_NotExistsSubQuery_AccessResultDataAsOneMap;
    public Map<String, AccessResultDataCQ> getId_NotExistsSubQuery_AccessResultDataAsOne() { return _id_NotExistsSubQuery_AccessResultDataAsOneMap; }
    public String keepId_NotExistsSubQuery_AccessResultDataAsOne(AccessResultDataCQ subQuery) {
        if (_id_NotExistsSubQuery_AccessResultDataAsOneMap == null) { _id_NotExistsSubQuery_AccessResultDataAsOneMap = newLinkedHashMap(); }
        String key = "subQueryMapKey" + (_id_NotExistsSubQuery_AccessResultDataAsOneMap.size() + 1);
        _id_NotExistsSubQuery_AccessResultDataAsOneMap.put(key, subQuery); return "id_NotExistsSubQuery_AccessResultDataAsOne." + key;
    }
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        ...
        if (baseQuery.hasConditionQueryAccessResultDataAsOne()) {
            unionQuery.queryAccessResultDataAsOne().reflectRelationOnUnionQuery(baseQuery.queryAccessResultDataAsOne(), unionQuery.queryAccessResultDataAsOne());
        }
    }
    ...
    protected AccessResultDataCQ xcreateQueryAccessResultDataAsOne() {
        ...
        AccessResultDataCQ cq = new AccessResultDataCQ(this, getSqlClause(), jan, getNextNestLevel());
        cq.xsetForeignPropertyName("accessResultDataAsOne"); cq.xsetRelationPath(nrp); return cq;
    }
    ...
    public Map<String, AccessResultCQ> getScalarSubQuery() { return _scalarSubQueryMap; }
    ...
    public Map<String, AccessResultCQ> getMyselfInScopeSubQuery() { return _myselfInScopeSubQueryMap; }
