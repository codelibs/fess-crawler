...
public class UrlQueueDbm extends AbstractDBMeta {
    ...
    public String getTablePropertyName() { return "urlQueue"; }
    public String getTableSqlName() { return "URL_QUEUE"; }

    // ===================================================================================
    //                                                                         Column Info
    //                                                                         ===========
    protected ColumnInfo _columnId = cci("ID", null, "id", Long.class, true, true, null, null);
    protected ColumnInfo _columnSessionId = cci("SESSION_ID", null, "sessionId", String.class, false, false, 20, 0);
    protected ColumnInfo _columnMethod = cci("METHOD", null, "method", String.class, false, false, 10, 0);
    protected ColumnInfo _columnUrl = cci("URL", null, "url", String.class, false, false, 65536, 0);
    protected ColumnInfo _columnParentUrl = cci("PARENT_URL", null, "parentUrl", String.class, false, false, 65536, 0);
    protected ColumnInfo _columnDepth = cci("DEPTH", null, "depth", Integer.class, false, false, null, null);
    protected ColumnInfo _columnCreateTime = cci("CREATE_TIME", null, "createTime", java.sql.Timestamp.class, false, false, null, null);
    ...
    public String getConditionBeanTypeName() { return "org.seasar.robot.db.cbean.bs.UrlQueueCB"; }
    public String getDaoTypeName() { return "org.seasar.robot.db.exdao.UrlQueueDao"; }
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected Map<String, Eps<UrlQueue>> _epsMap = StringKeyMap.createAsFlexibleConcurrent();
    {
    ...
    { public void setup(UrlQueue e, Object v) { e.setId((Long)v); } }
    public static class EpsSessionId implements Eps<UrlQueue>
    { public void setup(UrlQueue e, Object v) { e.setSessionId((String)v); } }
    public static class EpsMethod implements Eps<UrlQueue>
    { public void setup(UrlQueue e, Object v) { e.setMethod((String)v); } }
    public static class EpsUrl implements Eps<UrlQueue>
    { public void setup(UrlQueue e, Object v) { e.setUrl((String)v); } }
    public static class EpsParentUrl implements Eps<UrlQueue>
    { public void setup(UrlQueue e, Object v) { e.setParentUrl((String)v); } }
    public static class EpsDepth implements Eps<UrlQueue>
    { public void setup(UrlQueue e, Object v) { e.setDepth((Integer)v); } }
    public static class EpsCreateTime implements Eps<UrlQueue>
    { public void setup(UrlQueue e, Object v) { e.setCreateTime((java.sql.Timestamp)v); } }
}
