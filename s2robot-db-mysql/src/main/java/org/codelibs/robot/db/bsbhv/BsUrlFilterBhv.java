...
public abstract class BsUrlFilterBhv extends AbstractBehaviorWritable<UrlFilter, UrlFilterCB> {
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">urlFilter</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">urlFilter</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * UrlFilter <span style="color: #553000">urlFilter</span> = <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     * ... = <span style="color: #553000">urlFilter</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlFilter. (NotNull)
     ...
     * <pre>
     * ListResultBean&lt;UrlFilter&gt; <span style="color: #553000">urlFilterList</span> = <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (UrlFilter <span style="color: #553000">urlFilter</span> : <span style="color: #553000">urlFilterList</span>) {
     *     ... = <span style="color: #553000">urlFilter</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlFilter. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;UrlFilter&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (UrlFilter urlFilter : <span style="color: #553000">page</span>) {
     *     ... = urlFilter.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlFilter. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * <pre>
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * UrlFilter urlFilter = <span style="color: #70226C">new</span> UrlFilter();
     ...
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">insert</span>(urlFilter);
     ...
     * urlFilter.<span style="color: #CC4747">setVersionNo</span>(value);
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">update</span>(urlFilter);
     * </pre>
     * @param urlFilter The entity of update. (NotNull, PrimaryKeyNotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
     ...
     * @param urlFilter The entity of insert or update. (NotNull, ...depends on insert or update)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
     ...
     *     <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">delete</span>(urlFilter);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     * @param urlFilter The entity of delete. (NotNull, PrimaryKeyNotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
     ...
     * }
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">batchInsert</span>(urlFilterList);
     * </pre>
     ...
     *     urlFilterList.add(urlFilter);
     * }
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">batchUpdate</span>(urlFilterList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;UrlFilter, UrlFilterCB&gt;() {
     ...
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">queryUpdate</span>(urlFilter, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">queryDelete</span>(urlFilter, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of UrlFilter. (NotNull)
     ...
     * urlFilter.setFoo...(value);
     * urlFilter.setBar...(value);
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">varyingInsert</span>(urlFilter, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(urlFilter, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @param urlFilter The entity of insert or update. (NotNull)
     ...
     * @param urlFilter The entity of delete. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//urlFilter.setVersionNo(value);</span>
     * <span style="color: #0000C0">urlFilterBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(urlFilter, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * urlFilterBhv.outideSql().selectCursor(pmb, handler); <span style="color: #3F7E5E">// (by handler)</span>
     ...
     * urlFilterBhv.outideSql().traditionalStyle().selectPagedListOnly(path, pmb, entityType);
