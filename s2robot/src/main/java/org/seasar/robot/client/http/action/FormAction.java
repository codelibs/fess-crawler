...
public class FormAction extends BaseUrlAction {
     ...
     * 
     * @see
     * org.seasar.robot.client.http.action.UrlAction#navigate(org.openqa.selenium
     ...
     * (non-Javadoc)
     * 
     * @see org.seasar.robot.client.http.action.UrlAction#collect(java.lang
     * .String, org.openqa.selenium.WebDriver,
     * org.seasar.robot.entity.ResponseData)
     */
    @Override
