...
public class UrlQueueDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnMetaData = cci("META_DATA", "META_DATA", null, null, String.class, "metaData", null, false, false, false, "TEXT", 65535, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnEncoding = cci("ENCODING", "ENCODING", null, null, String.class, "encoding", null, false, false, false, "VARCHAR", 20, 0, null, false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnDepth = cci("DEPTH", "DEPTH", null, null, Integer.class, "depth", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null);
    protected final ColumnInfo _columnLastModified = cci("LAST_MODIFIED", "LAST_MODIFIED", null, null, java.sql.Timestamp.class, "lastModified", null, false, false, false, "DATETIME", 19, 0, null, false, null, null, null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.codelibs.robot.db.exentity.UrlQueue"; }
    public String getConditionBeanTypeName() { return "org.codelibs.robot.db.cbean.UrlQueueCB"; }
    public String getBehaviorTypeName() { return "org.codelibs.robot.db.exbhv.UrlQueueBhv"; }
