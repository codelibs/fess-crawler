...
/**
 * Hc5JcifsEngine is a NTLM Engine implementation for Apache HttpComponents 5.x based on JCIFS.
 *
 * @author shinsuke
 *
 */
public class Hc5JcifsEngine implements NTLMEngine {
    ...
    /**
     * Constructs a Hc5JcifsEngine with the specified properties.
     *
     ...
     */
    public Hc5JcifsEngine(final Properties props) {
        try {
     ...
     */
    @Override
    public String generateType3Msg(final String username, final char[] password, final String domain, final String workstation,
        ...
        try {
            final Type3Message type3Message =
                    new Type3Message(cifsContext, type2Message, null, new String(password), domain, username, workstation, type3Flags);
