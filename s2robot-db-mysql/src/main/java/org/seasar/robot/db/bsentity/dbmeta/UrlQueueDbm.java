...
public class UrlQueueDbm extends AbstractDBMeta {
    ...
    protected ColumnInfo _columnDepth = cci("DEPTH", null, "depth", Integer.class, false, false, 10, 0, false, null);
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected final Map<String, Eps<UrlQueue>> _epsMap = StringKeyMap.createAsFlexibleConcurrent();
    {
    ...
    { public void setup(UrlQueue e, Object v) { e.setLastModified((java.sql.Timestamp)v); } }
