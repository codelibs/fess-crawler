...
public class UrlFilterDbm extends AbstractDBMeta {
    ...
    public String getTablePropertyName() { return "urlFilter"; }
    public String getTableSqlName() { return "URL_FILTER"; }
    ...
    protected ColumnInfo _columnFilterType = cci("FILTER_TYPE", null, "filterType", String.class, false, false, 1, 0, false, null);
    ...
    public String getConditionBeanTypeName() { return "org.seasar.robot.db.cbean.bs.UrlFilterCB"; }
    public String getDaoTypeName() { return "org.seasar.robot.db.exdao.UrlFilterDao"; }
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected final Map<String, Eps<UrlFilter>> _epsMap = StringKeyMap.createAsFlexibleConcurrent();
    {
    ...
    { public void setup(UrlFilter e, Object v) { e.setId((Long)v); } }
    public static class EpsSessionId implements Eps<UrlFilter>
    { public void setup(UrlFilter e, Object v) { e.setSessionId((String)v); } }
    public static class EpsUrl implements Eps<UrlFilter>
    { public void setup(UrlFilter e, Object v) { e.setUrl((String)v); } }
    public static class EpsFilterType implements Eps<UrlFilter>
    { public void setup(UrlFilter e, Object v) { e.setFilterType((String)v); } }
    public static class EpsCreateTime implements Eps<UrlFilter>
    { public void setup(UrlFilter e, Object v) { e.setCreateTime((java.sql.Timestamp)v); } }
}
