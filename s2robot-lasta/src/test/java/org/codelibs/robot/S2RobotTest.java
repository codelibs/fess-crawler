...
public class S2RobotTest extends LastaDiTestCase {
    ...
    public void test_execute_bg() throws Exception {
        ...
        try {
            ...
            ((UrlFilterImpl) s2Robot.urlFilter).setIncludeFilteringPattern("$1$2$3.*");
            s2Robot.addUrl(url);
    ...
    public void test_execute_2instance() throws Exception {
        ...
        try {
            ...
            final S2Robot s2Robot1 = robotContainer.getComponent("s2Robot");
            ...
            final S2Robot s2Robot2 = robotContainer.getComponent("s2Robot");
