...
public class EmbeddedVariableCommentPropertyReadFailureException extends RuntimeException {
     ...
     */
    public EmbeddedVariableCommentPropertyReadFailureException(String msg) {
        super(msg);
    }
     ...
     */
    public EmbeddedVariableCommentPropertyReadFailureException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
