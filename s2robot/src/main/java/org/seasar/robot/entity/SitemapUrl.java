...
public class SitemapUrl implements Sitemap {
     ...
     *  the server can return, and search engines may use the information 
     ...
     * Even though search engine crawlers may consider this information when making 
     * decisions, they may crawl pages marked "hourly" less frequently than that, 
     * and they may crawl pages marked "yearly" more frequently than that. Crawlers 
     * may periodically crawl pages marked "never" so that they can handle unexpected 
     ...
     *  to pages on other sites—it only lets the search engines know which pages 
     ...
     *  may use this information when selecting between URLs on the same site, 
     *  so you can use this tag to increase the likelihood that your most important pages 
     *  are present in a search index.
     *  
     *  Also, please note that assigning a high priority to all of the URLs on your site 
     *  is not likely to help you. Since the priority is relative, it is only used to 
     *  select between URLs on your site.
     */
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof SitemapUrl)) {
            return false;
        }
