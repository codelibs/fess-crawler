...
import org.codelibs.fess.crawler.db.cbean.cq.bs.BsAccessResultDataCQ;
...
public class AccessResultDataCQ extends BsAccessResultDataCQ {
     ...
     */
    public AccessResultDataCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
