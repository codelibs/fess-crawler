...
public abstract class AbstractBsAccessResultDataCQ extends AbstractConditionQuery {
     ...
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setData_LikeSearch(String data, LikeSearchOption likeSearchOption) {
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setData_NotLikeSearch(String data, LikeSearchOption likeSearchOption) {
    ...
    protected SSQFunction<AccessResultDataCB> xcreateSSQFunction(final String operand) {
        return new SSQFunction<AccessResultDataCB>(new SSQSetupper<AccessResultDataCB>() {
