...
public class AOnClickAction extends BaseUrlAction {
     ...
     * 
     * @see
     * org.seasar.robot.client.UrlProcessor#navigate(org.openqa.selenium.WebDriver
     * , java.util.Map)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.seasar.robot.client.UrlProcessor#collect(java.lang.String,
     * org.openqa.selenium.WebDriver, org.seasar.robot.entity.ResponseData)
     */
    @Override
