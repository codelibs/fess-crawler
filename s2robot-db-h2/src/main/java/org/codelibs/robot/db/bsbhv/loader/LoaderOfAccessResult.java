...
public class LoaderOfAccessResult {
    ...
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfAccessResult ready(final List<AccessResult> selectedList,
    ...
    protected AccessResultBhv myBhv() {
        if (_myBhv != null) {
            ...
            _myBhv = _selector.select(AccessResultBhv.class);
            return _myBhv;
        }
    }
    ...
    public LoaderOfAccessResultData pulloutAccessResultDataAsOne() {
        if (_foreignAccessResultDataAsOneLoader == null) {
            _foreignAccessResultDataAsOneLoader = new LoaderOfAccessResultData()
                    .ready(myBhv().pulloutAccessResultDataAsOne(_selectedList),
                            _selector);
        }
