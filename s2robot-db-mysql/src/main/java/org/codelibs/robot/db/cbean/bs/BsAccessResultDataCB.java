...
public class BsAccessResultDataCB extends AbstractConditionBean {
    ...
    public AccessResultDataCQ getConditionQuery() { // public for parameter comment and internal
     ...
     * <pre>
     * cb.query().<span style="color: #DD4747">union</span>(new UnionQuery&lt;AccessResultDataCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #DD4747">unionAll</span>(new UnionQuery&lt;AccessResultDataCB&gt;() {
     *     public void query(AccessResultDataCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #DD4747">setupSelect_AccessResult()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     * cb.query().setFoo...(value);
     * AccessResultData accessResultData = accessResultDataBhv.selectEntityWithDeletedCheck(cb);
     * ... = accessResultData.<span style="color: #DD4747">getAccessResult()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<AccessResultDataCQ>() {
                ...
                public AccessResultDataCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<AccessResultDataCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnTransformerName() { return doColumn("TRANSFORMER_NAME"); }
        /**
         * DATA: {LONGBLOB(2147483647)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnData() { return doColumn("DATA"); }
        /**
         * ENCODING: {VARCHAR(20)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnEncoding() { return doColumn("ENCODING"); }
        ...
        public AccessResultCB.HpSpecification specifyAccessResult() {
            ...
            if (_accessResult == null) {
                _accessResult = new AccessResultCB.HpSpecification(_baseCB, new HpSpQyCall<AccessResultCQ>() {
                    public boolean has() { return _qyCall.has() && _qyCall.qy().hasConditionQueryAccessResult(); }
                    public AccessResultCQ qy() { return _qyCall.qy().queryAccessResult(); } }
                    , _purpose, _dbmetaProvider);
                if (xhasSyncQyCall()) { // inherits it
                    _accessResult.xsetSyncQyCall(new HpSpQyCall<AccessResultCQ>() {
                        public boolean has() { return xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryAccessResult(); }
                        public AccessResultCQ qy() { return xsyncQyCall().qy().queryAccessResult(); }
                    });
                }
            }
        ...
        public HpSDRFunction<AccessResultDataCB, AccessResultDataCQ> myselfDerived() {
            ...
            return new HpSDRFunction<AccessResultDataCB, AccessResultDataCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<AccessResultDataCB, AccessResultDataCQ>() {
                public void setup(String fn, SubQuery<AccessResultDataCB> sq, AccessResultDataCQ cq, String al, DerivedReferrerOption op) {
     ...
     * cb.<span style="color: #DD4747">columnQuery</span>(new SpecifyQuery&lt;AccessResultDataCB&gt;() {
    ...
    public HpColQyOperand<AccessResultDataCB> columnQuery(final SpecifyQuery<AccessResultDataCB> leftSpecifyQuery) {
        return new HpColQyOperand<AccessResultDataCB>(new HpColQyHandler<AccessResultDataCB>() {
            public HpCalculator handle(SpecifyQuery<AccessResultDataCB> rightSp, String operand) {
     ...
     * cb.<span style="color: #DD4747">orScopeQuery</span>(new OrQuery&lt;AccessResultDataCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<AccessResultDataCB> orQuery) {
     ...
     *     public void query(AccessResultDataCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #DD4747">orScopeQueryAndPart</span>(new AndQuery&lt;AccessResultDataCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<AccessResultDataCB> andQuery) {
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        ...
        specify().xsetSyncQyCall(new HpSpQyCall<AccessResultDataCQ>() {
            public boolean has() { return true; }
            public AccessResultDataCQ qy() { return cb.query(); }
        });
    }
