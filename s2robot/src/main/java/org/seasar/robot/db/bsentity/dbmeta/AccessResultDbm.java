...
public class AccessResultDbm extends AbstractDBMeta {
    ...
    protected ColumnInfo _columnRuleId = cci("RULE_ID", null, "ruleId", String.class, false, false, 20, 0);
    ...
    protected ColumnInfo _columnStatus = cci("STATUS", null, "status", Integer.class, false, false, null, null);
    protected ColumnInfo _columnHttpStatusCode = cci("HTTP_STATUS_CODE", null, "httpStatusCode", Integer.class, false, false, null, null);
    protected ColumnInfo _columnMethod = cci("METHOD", null, "method", String.class, false, false, 10, 0);
    protected ColumnInfo _columnMimeType = cci("MIME_TYPE", null, "mimeType", String.class, false, false, 100, 0);
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected Map<String, Eps<AccessResult>> _epsMap = StringKeyMap.createAsFlexibleConcurrent();
    {
