...
public abstract class BsUrlQueue implements Entity, Serializable, Cloneable {
    ...
    /**
     * [get] LAST_MODIFIED: {DATETIME(19)} <br />
    ...
    /**
     * [set] LAST_MODIFIED: {DATETIME(19)} <br />
