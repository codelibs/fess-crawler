...
public class BsUrlFilterCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public UrlFilterCB acceptPK(Long id) {
        assertObjectNotNull("id", id);
        BsUrlFilterCB cb = this;
        cb.query().setId_Equal(id);
        return (UrlFilterCB)this;
    }
    ...
    public UrlFilterCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected UrlFilterCQ doGetConditionQuery() {
    ...
    protected UrlFilterCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        UrlFilterCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected UrlFilterCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<UrlFilterCB> unionCBLambda) {
        final UrlFilterCB cb = new UrlFilterCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
     ...
     */
    public void unionAll(UnionQuery<UrlFilterCB> unionCBLambda) {
        final UrlFilterCB cb = new UrlFilterCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<UrlFilterCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnFilterType() { return doColumn("FILTER_TYPE"); }
        /**
        ...
        public HpSDRFunction<UrlFilterCB, UrlFilterCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<UrlFilterCB> sq, UrlFilterCQ cq, String al, DerivedReferrerOption op)
    ...
    public UrlFilterCB dreamCruiseCB() {
        ...
        cb.xsetupForDreamCruise((UrlFilterCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<UrlFilterCB> columnQuery(final SpecifyQuery<UrlFilterCB> colCBLambda) {
     ...
     */
    public void orScopeQuery(OrQuery<UrlFilterCB> orCBLambda) {
        xorSQ((UrlFilterCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<UrlFilterCB> andCBLambda) {
        xorSQAP((UrlFilterCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return UrlFilterCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return UrlFilterCQ.class.getName(); }
