...
public class BsAccessResultDataCQ extends AbstractBsAccessResultDataCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsAccessResultDataCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public AccessResultDataCIQ inline() {
        if (_inlineQuery == null) {
            _inlineQuery = new AccessResultDataCIQ(getChildQuery(), getSqlClause(), getAliasName(), getNestLevel(), this);
        }
    ...
    public AccessResultDataCIQ on() {
        ...
        AccessResultDataCIQ inlineQuery = inline(); inlineQuery.xsetOnClauseInline(true); return inlineQuery;
    }
    ...
    public Map<String, AccessResultCQ> getId_InScopeSubQuery_AccessResult() { return _id_InScopeSubQuery_AccessResultMap; }
    public String keepId_InScopeSubQuery_AccessResult(AccessResultCQ subQuery) {
        if (_id_InScopeSubQuery_AccessResultMap == null) { _id_InScopeSubQuery_AccessResultMap = newLinkedHashMap(); }
        String key = "subQueryMapKey" + (_id_InScopeSubQuery_AccessResultMap.size() + 1);
        _id_InScopeSubQuery_AccessResultMap.put(key, subQuery); return "id_InScopeSubQuery_AccessResult." + key;
    }
    ...
    protected void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
        ...
        if (baseQuery.hasConditionQueryAccessResult()) {
            unionQuery.queryAccessResult().reflectRelationOnUnionQuery(baseQuery.queryAccessResult(), unionQuery.queryAccessResult());
        }
    }
    ...
    protected AccessResultCQ xcreateQueryAccessResult() {
        ...
        AccessResultCQ cq = new AccessResultCQ(this, getSqlClause(), jan, getNextNestLevel());
        cq.xsetForeignPropertyName("accessResult"); cq.xsetRelationPath(nrp); return cq;
    }
    ...
    public Map<String, AccessResultDataCQ> getScalarSubQuery() { return _scalarSubQueryMap; }
    ...
    public Map<String, AccessResultDataCQ> getMyselfInScopeSubQuery() { return _myselfInScopeSubQueryMap; }
