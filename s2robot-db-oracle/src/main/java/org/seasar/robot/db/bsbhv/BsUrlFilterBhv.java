...
public abstract class BsUrlFilterBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends UrlFilter> void doSelectCursor(final UrlFilterCB cb,
    ...
    protected <ENTITY extends UrlFilter> ENTITY doSelectByPKValue(final Long id,
     ...
     */
    public int queryInsert(final QueryInsertSetupper<UrlFilter, UrlFilterCB> setupper) {
    ...
    protected int doQueryUpdate(final UrlFilter urlFilter, final UrlFilterCB cb,
            final UpdateOption<UrlFilterCB> option) {
        assertObjectNotNull("urlFilter", urlFilter);
        assertCBNotNull(cb);
        prepareUpdateOption(option);
    ...
    protected int doQueryDelete(final UrlFilterCB cb, final DeleteOption<UrlFilterCB> option) {
        assertCBNotNull(cb);
        prepareDeleteOption(option);
     ...
     */
    public int varyingQueryUpdate(final UrlFilter urlFilter, final UrlFilterCB cb,
            final UpdateOption<UrlFilterCB> option) {
        assertUpdateOptionNotNull(option);
    ...
    protected <ENTITY extends UrlFilter> void delegateSelectCursor(
            final UrlFilterCB cb, final EntityRowHandler<ENTITY> erh, final Class<ENTITY> et) {
    ...
    // Update
    // ------
    protected int delegateInsert(final UrlFilter e, final InsertOption<UrlFilterCB> op) {
    ...
    protected int delegateUpdate(final UrlFilter e, final UpdateOption<UrlFilterCB> op) {
    ...
    protected int delegateDelete(final UrlFilter e, final DeleteOption<UrlFilterCB> op) {
    ...
    protected int delegateQueryInsert(final UrlFilter e, final UrlFilterCB inCB,
            final ConditionBean resCB, final InsertOption<UrlFilterCB> op) {
