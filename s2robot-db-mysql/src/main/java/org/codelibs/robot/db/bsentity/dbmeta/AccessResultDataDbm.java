...
public class AccessResultDataDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnData = cci("DATA", "DATA", null, null, byte[].class, "data", null, false, false, false, "LONGBLOB", 2147483647, 0, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignAccessResult() {
        ...
        return cfi("ACCESS_RESULT_DATA_ibfk_1", "accessResult", this, AccessResultDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, true, false, false, false, null, null, false, "accessResultDataAsOne", false);
    }
