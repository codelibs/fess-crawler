...
public abstract class BsAccessResultDataBhv extends AbstractBehaviorWritable {
    ...
    protected int doSelectCountUniquely(final AccessResultDataCB cb) { // called by
                                                                 // selectCount(cb)
        assertCBNotNull(cb);
        return delegateSelectCountUniquely(cb);
    }

    protected int doSelectCountPlainly(final AccessResultDataCB cb) { // called by
                                                                // selectPage(cb)
        assertCBNotNull(cb);
    ...
    protected <ENTITY extends AccessResultData> void doSelectCursor(
            final AccessResultDataCB cb, final EntityRowHandler<ENTITY> entityRowHandler,
    ...
    protected <ENTITY extends AccessResultData> ENTITY doSelectEntity(
        ...
        return helpSelectEntityInternally(
            ...
            new InternalSelectEntityCallback<ENTITY, AccessResultDataCB>() {
                public List<ENTITY> callbackSelectList(final AccessResultDataCB cb) {
     ...
     */
    public ListResultBean<AccessResultData> selectList(final AccessResultDataCB cb) {
    ...
    public List<AccessResult> pulloutAccessResult(
        ...
        return helpPulloutInternally(
            ...
            new InternalPulloutCallback<AccessResultData, AccessResult>() {
                ...
                public void setRfLs(final AccessResult e, final List<AccessResultData> ls) {
                    if (!ls.isEmpty()) {
    ...
    protected void prepareInsertOption(final InsertOption<AccessResultDataCB> option) {
        if (option == null) {
            return;
        }
    ...
    protected void prepareUpdateOption(final UpdateOption<AccessResultDataCB> option) {
        if (option == null) {
            return;
        }
    ...
    protected void prepareDeleteOption(final DeleteOption<AccessResultDataCB> option) {
        if (option == null) {
            return;
        }
    ...
    protected int[] doBatchInsert(final List<AccessResultData> accessResultDataList,
            final InsertOption<AccessResultDataCB> option) {
    ...
    protected int[] doBatchUpdate(final List<AccessResultData> accessResultDataList,
            final UpdateOption<AccessResultDataCB> option) {
        assertObjectNotNull("accessResultDataList", accessResultDataList);
        prepareUpdateOption(option);
    ...
    protected int[] doBatchDelete(final List<AccessResultData> accessResultDataList,
            final DeleteOption<AccessResultDataCB> option) {
        assertObjectNotNull("accessResultDataList", accessResultDataList);
        prepareDeleteOption(option);
    ...
    protected int doQueryUpdate(final AccessResultData accessResultData,
            final AccessResultDataCB cb, final UpdateOption<AccessResultDataCB> option) {
        assertObjectNotNull("accessResultData", accessResultData);
        assertCBNotNull(cb);
        prepareUpdateOption(option);
    ...
    protected int[] delegateBatchUpdateNonstrict(final List<AccessResultData> ls,
            final UpdateOption<AccessResultDataCB> op) {
        if (ls.isEmpty()) {
            return new int[] {};
        }
    ...
    protected int[] delegateBatchDeleteNonstrict(final List<AccessResultData> ls,
            final DeleteOption<AccessResultDataCB> op) {
        if (ls.isEmpty()) {
            return new int[] {};
        }
    ...
    protected int delegateQueryUpdate(final AccessResultData e,
            final AccessResultDataCB cb, final UpdateOption<AccessResultDataCB> op) {
