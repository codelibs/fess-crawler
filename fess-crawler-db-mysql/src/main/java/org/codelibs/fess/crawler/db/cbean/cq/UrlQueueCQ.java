...
import org.codelibs.fess.crawler.db.cbean.cq.bs.BsUrlQueueCQ;
...
public class UrlQueueCQ extends BsUrlQueueCQ {
     ...
     */
    public UrlQueueCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
